class NutritionCalculatorService {
  ...
  /// Günlük su ihtiyacı hesaplama (bardak sayısı)
  /// Formül: kilo × 0.033 litre, sonra bardak sayısına çevir (1 bardak ≈ 0.267 litre, yani 3.75 bardak = 1 litre)
  /// Minimum 4, maksimum 12 bardak
  static int calculateWaterTarget(int? weight) {
    if (weight == null || weight <= 0) return 8; // Varsayılan değer
    final waterInLiters = weight * 0.033;
    final calculatedWaterTarget = (waterInLiters * 3.75).round();
    return calculatedWaterTarget.clamp(4, 12);
  }
}
